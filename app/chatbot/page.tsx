...
import { subscribe } from '@/src/lib/notify'
      ...
      <section className="soon-hero">
        <div className="wrap soon-inner">
          ...
          <motion.span className="pill pill-accent" {...rev}>
            <span className="dot" aria-hidden="true" />{' '}Hamarosan
          </motion.span>
          ...
          {submitted ? (
            ...
            <motion.form className="notify" onSubmit={handleNotify} {...rev}>
              <label className="sr-only" htmlFor="notify-email-chatbot">Email cím</label>
              <input

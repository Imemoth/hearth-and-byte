        ...
        <div className="wrap hero-grid">
          <div className="hero-copy">
            ...
            <motion.div className="hero-cta" {...r}>
              <Link className="btn btn-primary btn-lg" href="/akadalymentesites">
                Akadálymentesítés{' '}
                <svg aria-hidden="true" className="lucide" viewBox="0 0 24 24" width="20" height="20">
                  <use href="#i-arrow" />
                </svg>
              </Link>
              <Link className="btn btn-ghost btn-lg" href="/kapcsolat">Kapcsolatfelvétel</Link>
            </motion.div>
      ...
      <section className="section" aria-labelledby="svc-title">
        <div className="wrap">
          ...
          <div className="svc-grid">
            <motion.div {...r}>
              <Link className="card svc" href="/akadalymentesites">
            ...
            <motion.div {...r}>
              <Link className="card svc is-soon" href="/chatbot">
                <span className="icon-badge">
                  <svg aria-hidden="true" className="lucide" viewBox="0 0 24 24" width="26" height="26">
                    <use href="#i-chat" />
                  </svg>
            ...
            <motion.div {...r}>
              <Link className="card svc is-soon" href="/honlap">
                <span className="icon-badge">
                  <svg aria-hidden="true" className="lucide" viewBox="0 0 24 24" width="26" height="26">
                    <use href="#i-monitor" />
                  </svg>

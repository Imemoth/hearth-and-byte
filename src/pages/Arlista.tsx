          ...
          <section>
            ...
            <div className="plan-grid">
              ...
              <motion.div className="card plan" {...rev}>
                ...
                <Link to="/kapcsolat" className="btn btn-ghost">Audit kérése</Link>
              </motion.div>
              ...
              <motion.div className="card plan featured" {...rev}>
                ...
                <Link to="/kapcsolat" className="btn btn-primary">Ajánlatot kérek</Link>
              </motion.div>
              ...
              <motion.div className="card plan" {...rev}>
                ...
                <Link to="/kapcsolat" className="btn btn-ghost">Nyilatkozatot kérek</Link>
              </motion.div>
            </div>
